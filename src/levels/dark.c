...
void updateProcDark(GContext* _ctx) {
  ...
  //     drawBitmap(_ctx, m_fire[0], 4 + (4 * _f) , 5 + (4 * _i));
  //     drawBitmap(_ctx, m_fire[1], 5 + (4 * _f) , 4 + (4 * _i));
  //   }
  // }
  //
  ...
  //   drawBitmap(_ctx, m_arrow, 5 + _off, 3);
  //   drawBitmap(_ctx, m_arrow, 5 + _off, 7);
  //   drawBitmap(_ctx, m_arrow, 5 + _off, 11);
  // }
