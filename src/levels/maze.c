...
static const uint16_t s_sollution[N_MAZES][3] = {{1,0,2}};
...
static const Maze_t s_mazes[N_MAZES] = {
  [0].m_path0 = {5,4, 6,4, 6,9, 8,9, 8,10, 10,10, 10,14, 6,14, 6,17, 11,17, 11,11, 14,11, 14,10, 15,10},
  [0].m_path1 = {5,10, 6,10, 6,13, 7,13, 7, 3, 8,3, 8,7, 13,7, 13,6, 15,6},
  [0].m_path2 = {5,16, 8,16, 8,11, 9,11, 9,3, 11,3, 11,10, 13,10, 13,14, 15,14}
};
...
bool tickMaze(bool _doInit) {
 ...
 if (s_state == 0) { // start initial move
   ...
   if (getPlayerChoice() != s_sollution[s_maze][s_path]) {
     // Loose TODO check and take life
     m_dungeon.m_rooms[ m_dungeon.m_level ][ m_dungeon.m_room + 1 ] = kDeath;
   }
