...
static const uint16_t s_sollution[N_MAZES][3] = { {2,0,1}, {1,0,2}, {0,2,1}, {2,0,1}, {2,1,0}, {2,1,0}, {1,2,0}, {0,1,2} };
...
static const Maze_t s_mazes[N_MAZES] = {
  ...
  [5].m_path0 = {5,4, 13,4, 13,9, 9,9, 9,16, 14,16, 14,14, 15,14},
  [5].m_path1 = {5,10, 12,10, 12,7, 10,7, 10,3, 8,3, 8,14, 13,14, 13,10, 15,10},
  [5].m_path2 = {5,16, 7,16, 7,6, 15,6},
  [6].m_path0 = {5,4, 6,11, 12,7, 8,13, 15,14},
  [6].m_path1 = {5,10, 8,17, 14,13, 8,5, 12,3, 15,6},
  [6].m_path2 = {5,16, 12,13, 8,7, 12,5, 15,10},
  [7].m_path0 = {5,4, 7,4, 5,6, 11,12, 9,14, 11,16, 13,16, 13,12, 11,10, 15,6},
